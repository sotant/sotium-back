...
### Added
- Se creó el nuevo módulo `academy` con estructura hexagonal inicial (domain/application/infrastructure/interfaces), modelos de dominio base, puertos de persistencia y adapters JPA de arranque.
